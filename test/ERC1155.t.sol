...
contract MockERC1155 is ERC1155 {
    ...
    function batchMint(address to, uint256[] calldata ids) public virtual {
        _batchMint(to, ids);
    }
    ...
    function batchBurn(address from, uint256[] calldata ids) public virtual {
        _batchBurn(from, ids);
    }
}
