...
contract PageSolmateTest is Test, PageBase {
    function testCannotSafeTransferFromNotAuthorized(
        uint256 amount,
        bytes calldata data
    ) public {
    ...
    function testCannotSafeBatchTransferFromNotAuthorized() public {
        address from = accounts[0];
        address to = accounts[1];
    ...
    function testTransferFromToERC1155Recipient() public {
        ERC1155Recipient to = new ERC1155Recipient();
        ...
        page.setApprovalForAll(address(this), true);
        page.transferFrom(from, address(to), id);
    ...
    function testBatchTransferFromToERC1155Recipient() public {
        ...
        page.setApprovalForAll(address(this), true);
        page.batchTransferFrom(from, address(to), ids);
