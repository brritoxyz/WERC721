...
abstract contract PageExchange is ReentrancyGuard, PageToken, PageERC721 {
    ...
    function _deposit(uint256 id, address recipient) private {
        ...
        ERC721(collection()).transferFrom(msg.sender, address(this), id);
    }
    ...
    function _withdraw(uint256 id, address recipient) private {
        ...
        ERC721(collection()).safeTransferFrom(address(this), recipient, id);
    }
